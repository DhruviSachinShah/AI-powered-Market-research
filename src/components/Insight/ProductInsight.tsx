...
const ProductInsightPage: React.FC<ProductInsightPageProps> = ({ productId }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-purple-600 text-white py-12 px-6 shadow-lg">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="text-4xl font-bold">Product Insights Dashboard</h1>
          </div>
          <p className="text-blue-100 text-lg">Comprehensive analysis and data visualization</p>
        </div>
      </div>
                ...
                return (
                  <div key={index} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border border-gray-100">
                    <div className="flex items-start gap-3 mb-5">
                      ...
                      <h3 className="text-lg font-semibold text-gray-800 leading-tight">{q.question_text}</h3>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center py-8">
                      <div className="relative w-48 h-48">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                          <span className="text-5xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">{value}</span>
                          <span className="text-gray-500 text-sm font-medium mt-1">out of 10</span>
                        </div>
                      </div>
                    </div>
                  </div>
